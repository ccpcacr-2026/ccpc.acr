...
function renderFollowCard(bus) {
  ...
  card.innerHTML = `
    ...
    <div style="display:flex;align-items:center;gap:6px;margin-top:8px;font-size:11px;font-weight:700;color:#475569"><i data-lucide="map-pin" style="width:13px;height:13px;color:#2563eb;flex-shrink:0"></i>${bus.address || 'Locating…'}</div>
  `;
  if (window.lucide) lucide.createIcons();
}
