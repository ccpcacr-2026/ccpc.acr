...
const RESERVED = [
  ...
  '_invOpenStockImportModal','_invConfirmStockImport','_invDistributeDeleteOne','_invDownloadStockImportSample',
  ...
  '_prFvToggleRowSelected','_prFvToggleSelectAllVisible','_prFvBulkApply',
  ...
  '_prBulkAddAllStaff','_prLoadExportColumns','_prSetExportFormat','_prSetAllHeaderRotation','_prAutoFitColumnsToPage','_prSetAllAlign','_prRemoveExportColumn','loadPayrollAuditLog',
  '_prSelectRemarksLog','_prDeleteRemarksLog','_prSaveRemarksToLog','_prToggleMyPayslip',
  ...
  '_prAddPayStep','_prDeletePayStep','_prSaveGradeStepValue',
  ...
  '_prAddVirtualColumn','_prEditVirtualColumn','_prCloseVirtualColumnForm','_prSaveVirtualColumn','_prExportExcel','_prExportPdf',
  ...
  'scmToggleClass','scmExpandAll','scmOpenWeights','scmSaveWeights','scmApplyPartToAll','scmPartActive','scmPartDelete','scmOpenClassCopy','scmDoClassCopy','scmSavePart','scmOpenScope','_scmScopeClassChanged','_scmScopePreview','scmSaveScope','scmOpenCopy','scmDoCopy','scmEditSubject','scmSaveSubjectEdit',
  ...
  'saveExamPattern','duplicateExamPattern','deleteExamPatternTemplate','editExamPattern','cancelExamPatternEdit','editExamGroup','cancelExamGroupEdit','examGroupAction','rbInit','rbApplyTemplate','rbSaveTemplate','rbDeleteTemplate','rbAddSource','rbRemoveSource','rbSetSource','rbPrepare','rbExport','rbPrint','_rbRenderSources','rcAddAllParts','rbEditTemplateClasses','rbSaveTemplateClasses','_rbFillTemplateSelect','rsOpenDesigner','rsCloseDesigner','rsSwitchPage','rsSetPage','rsSetZoom','rsResetPage','rsAddBlock','rsDeleteBlock','rsDuplicateBlock','rsOrderBlock','rsSetProp','rsToggleList','rsInsertField','rsPrintCards','rsPrintTabulation','rcRenderBuilder','rcDragStart','rcDrop','rcSetFmt','rcSetLabel','rcRemove','rcDuplicate','rcResetColumns','rcAdd','rcEdit','rcSetV','rcAddRule','rcRemoveRule','rcSetRule','rcInsertToken','rcSetEdit','rcSetItem','rcAddItem','rcMoveItem','rcRemoveItem','rcToggleBlockSubject','rcSetItemFmt','rcSetItemFmtVal','rcSaveEditor','rcSetPop','rcAddFilter','rcRemoveFilter','rcSetFilter','rcAddSort','rcRemoveSort','rcSetSort','_rcRenderEditor','_rcPathLabel','rcPickPath','rcTypeLabel','rsInfoAddField','rsInfoMove','rsInfoRemove','rsSigUpload','rsSigRename','rsSigRemove','rsSigAddRule','rsSigSetRule','rsSigRemoveRule','rsSetMarksXItems','toggleExamGroup','expandAllExamGroups','toggleExamPartOpen','setExamPartsOpen','meOpenSheet','meToggleManual','_meLoadCards','_meRenderCards','srOpen','srRender','srSync','srMapCode','stPanel','stRender','stToggleClass','stExpandAll','stSync','stMapShort','stSetTeacher','scmLoadTeachers',
