...
const RESERVED = [
  ...
  'scmToggleClass','scmExpandAll','scmOpenClassCopy','scmDoClassCopy','scmSavePart','scmOpenScope','_scmScopeClassChanged','_scmScopePreview','scmSaveScope','scmOpenCopy','scmDoCopy','scmEditSubject','scmSaveSubjectEdit',
