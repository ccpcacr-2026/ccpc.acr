...
const RESERVED = [
  ...
  'scmToggleClass','scmExpandAll','scmSavePart','scmOpenScope','_scmScopeClassChanged','_scmScopePreview','scmSaveScope','scmOpenCopy','scmDoCopy','scmEditSubject','scmSaveSubjectEdit',
