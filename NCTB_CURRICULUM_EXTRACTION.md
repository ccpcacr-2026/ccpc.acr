...
- [~] Class One — 10 subjects identified
  - [~] Mathematics (485MB, 184 pages, 18 chapters) — **Chapters 1-17 loaded into `lesson_curricula` (id 1-17), 103 lessons total, tagged `version: "English Version"` per CCPC's Nursery-Two rule.** Chapter 16 ("বিয়োগ" / Subtraction, textbook pages 101-104, 4 lessons — declared count matched actual) covers two-digit subtraction without borrowing (larger number ≤99), both vertical and horizontal formats, ending with word problems. Chapter 17 ("(বাংলাদেশি মুদ্রা)" / Bangladeshi Currency, textbook pages 105-108, 2 lessons — declared count matched actual) covers recognizing coins/notes up to 100 taka and role-played transactions/change-making. **Note from Chapter 5: its stated "পাঠ সংখ্যা" header undercounted (said 11, actually 13) — don't trust that figure as an early-stop signal, keep reading until a new "অধ্যায়" (chapter) header actually appears.** Chapter 18 (final chapter) starts at PDF page index ~180 (textbook page ~109) — see rendered page p180.png onward. This is the last chapter; the book ends at page index 183.
