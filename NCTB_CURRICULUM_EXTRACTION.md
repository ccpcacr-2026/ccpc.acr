...
- [~] Class One — 10 subjects identified
  - [~] Mathematics (485MB, 184 pages, 18 chapters) — **Chapters 1-15 loaded into `lesson_curricula` (id 1-15), 97 lessons total, tagged `version: "English Version"` per CCPC's Nursery-Two rule.** Chapter 14 ("সংখ্যা (৪১ থেকে ১০০)" / Numbers 41-100, textbook pages 92-96, 5 lessons — declared count matched actual) covers reading/writing numbers 41-100 in digits and words using tens-grouping. Chapter 15 ("যোগ" / Addition, textbook pages 97-100, 4 lessons — declared count matched actual) covers two-digit addition without carrying (sum ≤100), ending with real-life word problems. **Note from Chapter 5: its stated "পাঠ সংখ্যা" header undercounted (said 11, actually 13) — don't trust that figure as an early-stop signal, keep reading until a new "অধ্যায়" (chapter) header actually appears.** Chapter 16 ("বিয়োগ" / Subtraction, পাঠ সংখ্যা: 4 declared) starts at PDF page index 170 (textbook page 101). Chapters 16-18 remaining (see সূচিপত্র on rendered page index 6 of the downloaded PDF for the full chapter list/page ranges). Chapter length varies a lot so far: 1-2 had 4 each, 3 had 16, 4 had 13, 5 had 13, 6 had 3, 7 had 7, 8 had 4, 9 had 7, 10 had 4, 11 had 4, 12 had 4, 13 had 5, 14 had 5, 15 had 4 — pace accordingly.
