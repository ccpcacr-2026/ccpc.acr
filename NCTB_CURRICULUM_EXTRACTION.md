...
- [~] Class One — 10 subjects identified
  - [~] Mathematics (485MB, 184 pages, 18 chapters) — **Chapters 1-9 loaded into `lesson_curricula` (id 1-9), 71 lessons total, tagged `version: "English Version"` per CCPC's Nursery-Two rule — halfway through the book's 18 chapters.** Chapter 9 ("সংখ্যা ২১-৪০" / Numbers 21-40, textbook pages 69-73, 7 lessons — declared count matched actual) extends ten-bundle place value to 40 and introduces writing numbers as Bangla words (1-10). **Note from Chapter 5: its stated "পাঠ সংখ্যা" header undercounted (said 11, actually 13) — don't trust that figure as an early-stop signal, keep reading until a new "অধ্যায়" (chapter) header actually appears.** Chapter 10 starts at PDF page ~127 (textbook page 74, likely place value / স্থানীয়মান, per Chapter 9's closing announcement). Chapters 10-18 remaining (see সূচিপত্র on rendered page index 6 of the downloaded PDF for the full chapter list/page ranges). Chapter length varies a lot so far: 1-2 had 4 each, 3 had 16, 4 had 13, 5 had 13, 6 had 3, 7 had 7, 8 had 4, 9 had 7 — pace accordingly.
